...
const onlyTitles = recipes.map(e => Array(e.title)) // ['Crepes', ...]
// console.log(onlyTitles)



const titlesWithDuration = recipes.map(e => Array(e.title, e.duration)); // ['Crepes (60min)', ...]
// console.log(titlesWithDuration)



const timePerServing = recipes.map(e => e.duration/ e.servings)
...
const recipesThatOnlyTake60minutesOrLess = recipes.filter(e => e.duration <= 60)
...
const allRecipesWithTitlesLongerThan12Characters = recipes.filter(e => e.title.length > 12)
